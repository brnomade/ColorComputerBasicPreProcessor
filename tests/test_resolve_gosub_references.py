...
class TestResolveGosubReferences(unittest.TestCase):
    ...
    def test_scenario_1(self):
        ...
        file_handler.write("16 some code : GOSUB _scenario_01:                               " + glb_new_line_symbol)
        file_handler.write("17 some code: GOSUB           _scenario_01:                      " + glb_new_line_symbol)
        file_handler.write("18 some code:GOSUB_scenario_01:                                  " + glb_new_line_symbol)
        file_handler.write("19 some code :GOSUB_scenario_01:                                 " + glb_new_line_symbol)
        file_handler.write("20                                                               " + glb_new_line_symbol)
        file_handler.write("21 GOSUB scenario_01:                                            " + glb_new_line_symbol)
        file_handler.write("22 GOSUB           scenario_01:                                  " + glb_new_line_symbol)
        file_handler.write("23 GOSUBscenario_01:                                             " + glb_new_line_symbol)
        file_handler.write("24                                                               " + glb_new_line_symbol)
        file_handler.write("25 GOSUB _scenario_01                                            " + glb_new_line_symbol)
        file_handler.write("26 GOSUB           _scenario_01                                  " + glb_new_line_symbol)
        file_handler.write("27 GOSUB_scenario_01                                             " + glb_new_line_symbol)
        file_handler.write("28                                                               " + glb_new_line_symbol)
        file_handler.write("29 GOSUB scenario_01                                             " + glb_new_line_symbol)
        file_handler.write("30 GOSUB           scenario_01                                   " + glb_new_line_symbol)
        file_handler.write("31 GOSUBscenario_01                                              " + glb_new_line_symbol)
        file_handler.write("32                                                               " + glb_new_line_symbol)
        file_handler.write("33 GOSUB _scenario_01: : GOSUB _scenario_01:                     " + glb_new_line_symbol)
        file_handler.write("34 GOSUB _scenario_01:: commands : GOSUB _scenario_01:           " + glb_new_line_symbol)
        file_handler.write("35                                                               " + glb_new_line_symbol)
        file_handler.write("36 _scenario_02:                                                 " + glb_new_line_symbol)
        file_handler.write("37 _scenario_22:                                                 " + glb_new_line_symbol)
        file_handler.write("38                                                               " + glb_new_line_symbol)
        file_handler.write("39 GOSUB _scenario_23:                                           " + glb_new_line_symbol)
        file_handler.write("40 GOSUB                                                         " + glb_new_line_symbol)
        file_handler.write("41                                                               " + glb_new_line_symbol)
        file_handler.write("42 'GOSUB _scenario_22:                                          " + glb_new_line_symbol)
        file_handler.write("43 GOSUB  _scenario_02: ' GOSUB _scenario_22: GOSUB _scenario_30:" + glb_new_line_symbol)
        file_handler.write("44 commands : GOSUB  _scenario_02: commands ' GOSUB _scenario_22:" + glb_new_line_symbol)
        file_handler.write("45                                                               " + glb_new_line_symbol)
        file_handler.write("46 GOSUB_scenario_02::GOSUB_scenario_22::GOSUB _scenario_30:     " + glb_new_line_symbol)
        file_handler.close()
