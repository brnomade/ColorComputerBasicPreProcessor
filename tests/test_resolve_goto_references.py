...
class TestResolveGotoReferencesTest(unittest.TestCase):
    ...
    def test_scenario_1(self):
        ...
        file_handler.write("16 some code : GOTO _scenario_01:                               " + glb_new_line_symbol)
        file_handler.write("17 some code: GOTO           _scenario_01:                      " + glb_new_line_symbol)
        file_handler.write("18 some code:GOTO_scenario_01:                                  " + glb_new_line_symbol)
        file_handler.write("19 some code :GOTO_scenario_01:                                 " + glb_new_line_symbol)
        file_handler.write("20                                                              " + glb_new_line_symbol)
        file_handler.write("21 GOTO scenario_01:                                            " + glb_new_line_symbol)
        file_handler.write("22 GOTO           scenario_01:                                  " + glb_new_line_symbol)
        file_handler.write("23 GOTOscenario_01:                                             " + glb_new_line_symbol)
        file_handler.write("24                                                              " + glb_new_line_symbol)
        file_handler.write("25 GOTO _scenario_01                                            " + glb_new_line_symbol)
        file_handler.write("26 GOTO           _scenario_01                                  " + glb_new_line_symbol)
        file_handler.write("27 GOTO_scenario_01                                             " + glb_new_line_symbol)
        file_handler.write("28                                                              " + glb_new_line_symbol)
        file_handler.write("29 GOTO scenario_01                                             " + glb_new_line_symbol)
        file_handler.write("30 GOTO           scenario_01                                   " + glb_new_line_symbol)
        file_handler.write("31 GOTOscenario_01                                              " + glb_new_line_symbol)
        file_handler.write("32                                                              " + glb_new_line_symbol)
        file_handler.write("33 GOTO _scenario_01: : GOTO _scenario_01:                      " + glb_new_line_symbol)
        file_handler.write("34 GOTO _scenario_01:: commands : GOTO _scenario_01:            " + glb_new_line_symbol)
        ...
        file_handler.write("38 GOTO _scenario_22:                                           " + glb_new_line_symbol)
        file_handler.write("39 GOTO                                                         " + glb_new_line_symbol)
        file_handler.write("40                                                              " + glb_new_line_symbol)
        file_handler.write("41 'GOTO _scenario_22:                                          " + glb_new_line_symbol)
        file_handler.write("42 GOTO  _scenario_02: ' GOTO _scenario_22: GOTO _scenario_22:  " + glb_new_line_symbol)
        file_handler.close()
